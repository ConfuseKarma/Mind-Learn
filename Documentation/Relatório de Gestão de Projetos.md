...
- **Tendência de Custo**: Melhoria progressiva (CPI: 0.85 → 0.92)
- **Tendência de Prazo**: Recuperação em andamento (SPI: 0.75 → 0.80)
- **Previsão de Término**: 25/11 (ETC: 2 semanas)

## 7. **Gerenciamento de Qualidade**

### 7.1 **Processo de Verificação e Validação**
...
### 7.2 **Retrabalho e Ações Corretivas**
...
|-------------|----------|-----------|------------|---------------|
| **Cobertura de Testes** | 90% | 75% | 🟡 | ↗️ Melhorando |
| **Bugs Críticos** | 0 | 2 | 🔴 | ↘️ Reduzindo |
| **Debt Técnico** | < 5% | 8% | 🟡 | → Estável |
| **Velocidade da Equipe** | 40 pts/sprint | 35 pts/sprint | 🟡 | ↗️ Aumentando |
...
| **Falta de recursos** | Baixa | Alto | 🟢 | Alocação contingencial |
| **Problemas de infraestrutura** | Média | Alto | 🟡 | Backup e recuperação |
...
- **Impacto**: Lentidão nas consultas
- **Resposta**: Otimização de queries e índices
- **Resultado**: Performance dentro dos limites aceitáveis
- **Custo**: 12 horas de otimização

## 9. **Gerenciamento de Mudanças**

### 9.1 **Change Requests Aprovados**

| **Mudança** | **Solicitante** | **Impacto** | **Status** | **Justificativa** |
|-------------|----------------|-------------|------------|-------------------|
| **Adição de modo offline** | Product Owner | +2 sprints | ⏸️ Postergado | Complexidade técnica vs benefício |
| **Suporte a mais browsers** | Testes de Usabilidade | +1 sprint | ✅ Aprovado | Acessibilidade essencial |
| **Sistema de notificações** | Stakeholders | +3 sprints | ❌ Rejeitado | Fora do escopo do MVP |
| **Relatórios de progresso** | Professores | +1 sprint | ✅ Aprovado | Valor educacional significativo |

### 9.2 **Análise de Impacto nas Mudanças**
...
- **Benefícios**: Acesso ampliado a usuários
...
| **Stakeholder** | **Frequência** | **Canal** | **Responsável** | **Artefatos** |
|-----------------|----------------|-----------|-----------------|---------------|
| **Equipe de Desenvolvimento** | Diária | Daily Meeting | Scrum Master | Task boards, impediments |
| **Professores** | Semanal | Status Report | Product Owner | Relatórios de progresso |
| **Usuários Finais** | Quinzenal | Protótipos | Time completo | Feedback, testes usabilidade |
| **Coordenação** | Mensal | Apresentação | Scrum Master | Demonstrações, métricas |

### 10.2 **Eficácia da Comunicação**
...
- **85%** de satisfação com clareza das comunicações

### 10.3 **Ações de Melhoria**
- Implementação de canal dedicado no Discord
- Template padronizado para status reports
- Sessões de feedback após cada sprint review
- Documentação compartilhada em tempo real

## 11. **Gestão de Aquisições e Recursos**

### 11.1 **Recursos Alocados**

| **Recurso** | **Tipo** | **Quantidade** | **Custo** | **Fornecedor** |
|-------------|----------|----------------|-----------|----------------|
| **Equipamentos de Rede** | Físico | 8 roteadores + 4 switches | R$ 0 | Laboratório FESA |
| **Serviços de Nuvem** | Serviço | 1 instância | R$ 0 | Academic License |
| **Ferramentas de Desenvolvimento** | Software | 4 licenças | R$ 0 | GitHub Education |
| **Consultoria Técnica** | Humano | 10 horas | R$ 0 | Monitores da disciplina |

### 11.2 **Plano de Contingência**
- **Recursos humanos**: Membros podem assumir múltiplas funções
- **Infraestrutura**: Backup local de todos os dados
- **Prazos**: Buffer de 15% no cronograma
- **Escopo**: Funcionalidades prioritárias identificadas
...
- **Documentação**: Versionamento facilitou colaboração
...
### 12.3 **Recomendações para Próximos Projetos**
...
5. Manter registro de decisões técnicas e de negócio
6. Estabelecer métricas de qualidade desde o planejamento

## 13. **Encerramento do Projeto**

### 13.1 **Critérios de Aceitação Atendidos**
- [x] MVP funcional com autenticação e quizzes
- [x] Documentação técnica completa
- [x] Testes de aceitação realizados
- [x] Usabilidade validada com usuários piloto
- [x] Infraestrutura de deploy configurada

### 13.2 **Entregáveis Finalizados**

| **Entregável** | **Status** | **Data de Conclusão** | **Responsável** |
|----------------|------------|----------------------|-----------------|
| **Aplicação Web** | ✅ | 25/11/2024 | Time completo |
| **Documentação Técnica** | ✅ | 25/11/2024 | Roger, Marcos |
| **Relatórios Acadêmicos** | ✅ | 25/11/2024 | Todos |
| **Apresentação Final** | ✅ | 25/11/2024 | Kauê, Guilherme |
| **Código Fonte** | ✅ | 25/11/2024 | Time completo |

### 13.3 **Transição e Manutenção**
- **Repositório**: GitHub mantido por 1 ano
- **Documentação**: Atualizações semestrais
- **Suporte**: Equipe disponível por 3 meses
- **Evolução**: Roadmap para versão 2.0 definido
...
- **Processos ágeis** consolidados na equipe
- **Integração interdisciplinar** bem-sucedida

### 14.2 **Próximas Ações Prioritárias:**
...
**Distribuição**: Equipe do projeto, Orientadores, Coordenação
